...
export const SellerShippingHistoryTable = () => {
        ...
        <table className="table fs-sm">
          ...
          <tbody>
            ...
            {getSlicedData()?.map((history) => {
              return (
                <SellerShippingHistoryTableData
                  {...history}
                  key={history.id}
...
export const SellerShippingHistoryTableData = (props) => {
  const {
    product_name,
    vendor_name,
    vendor_email,
...
export default SellerShippingHistory;
