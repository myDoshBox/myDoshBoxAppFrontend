...
export const RecentTransactionTableData = (props) => {
  ...
  const navigateToConfirmEscrowProductPage = () =>
    navigate("/userdashboard/confirm-escrow-product-transaction");
        ...
        {vendor_email === buyer_email && seller_confirm_status === false ? (
          <td className="d-none d-md-table-cell py-md-3 text-center">
            <Button
              variant="outline-primary"
              className="rounded-1 fs-sm"
              onClick={() => navigate("confirm-escrow-product-transaction")}
            >
              Confirm Transaction
            </Button>
          </td>
...
// check if the vendor email === signed in user email: it should be confirm trans else view more
...
//     error,
//     isLoading,
//   } = useFetchAllTransactionsQuery("buyer_email@example.com"); // Fetch transaction data for a specific user
//   const [selectedTransaction, setSelectedTransaction] = useState(null); // For modal
...
//         {/* Transaction Summary Above Table */}
//         <div className="mb-3">
...
//           </thead>
//           <tbody>
//             {getSlicedData().map((transaction) => (
//               <RecentTransactionTableData
//                 {...transaction}
//                 key={transaction.id}
//                 onViewMore={() => handleShowMore(transaction)}
//               />
//             ))}
//           </tbody>
//         </table>
...
//             <Modal.Body>
//               <p>
//                 <strong>Item:</strong> {selectedTransaction.product_name}
//               </p>
//               <p>
...
//               </p>
//               <p>
//                 <strong>Purchase By:</strong> {selectedTransaction.buyer_email}
//               </p>
//               <p>
//                 <strong>Purchase Date:</strong> {selectedTransaction.createdAt}
//               </p>
//               <p>
...
//   const {
//     product_name: item,
//     vendor_email: purchase_from,
//     createdAt: purchase_date,
//     buyer_email: purchase_by,
...
//         <td className="py-md-3 text-center">{status}</td>
//         <td className="d-none d-md-table-cell py-md-3 text-center">
//           <Button
//             variant="outline-primary"
//             className="rounded-1 fs-sm"
